...
#define OLED_CMD_Set()      GPIO_WriteBit(OLED_DC_GPIO_Port, OLED_DC_Pin, Bit_SET)
#define OLED_CMD_Clr()      GPIO_WriteBit(OLED_DC_GPIO_Port, OLED_DC_Pin, Bit_RESET)

#define OLED_RST_Set()      GPIO_WriteBit(OLED_RST_GPIO_Port, OLED_RST_Pin, Bit_SET)
#define OLED_RST_Clr()      GPIO_WriteBit(OLED_RST_GPIO_Port, OLED_RST_Pin, Bit_RESET)
